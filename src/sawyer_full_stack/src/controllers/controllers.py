...
class PIDJointVelocityController(Controller):
    ...
    def step_control(self, target_position, target_velocity, target_acceleration):
        ...
        # print("integ")
        # print(self.integ_error.shape)
        # print("Kp")
        # print(current_error.shape)
        # print(self.Kp * current_error + self.Ki * self.integ_error)
        controller_velocity = target_velocity + self.Kp @ current_error + self.Ki @ self.integ_error + self.Kd @ (target_velocity - current_velocity)
        #print(target_velocity,controller_velocity)
        self._limb.set_joint_velocities(joint_array_to_dict(controller_velocity, self._limb))